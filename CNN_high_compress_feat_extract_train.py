...
train_feature_vecs=model_features.predict(X_train)


f=h5py.File('feature_vectors/train_features_cnn_high_compression.h5','w')
f.create_dataset('train_feature_vecs',data=train_feature_vecs)
f.close()
